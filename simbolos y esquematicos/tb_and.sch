...
C {devices/lab_pin.sym} -70 -30 0 0 {name=p3 sig_type=std_logic lab=A}
C {devices/lab_pin.sym} 0 -70 0 0 {name=p4 sig_type=std_logic lab=avdd1p8}
C {devices/lab_pin.sym} 0 70 0 0 {name=p6 sig_type=std_logic lab=avss1p8}
...
C {devices/lab_pin.sym} -70 30 0 0 {name=p13 sig_type=std_logic lab=B}
C {devices/lab_pin.sym} 130 -30 0 0 {name=p14 sig_type=std_logic lab=vout}
C {/foss/designs/and.sym} 70 0 0 0 {name=x1}
